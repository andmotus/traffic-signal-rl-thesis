...
national CO₂-reduction potential for Germany from the resulting findings.

## Structure
- `RESCO/` — benchmark framework (git submodule, unmodified)
- `src/` — classification wrapper, training scripts, analysis
- `docs/` — proposal, setup notes
